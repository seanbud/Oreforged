...
it('supports setting a facet multiple times in the same render', () => {
    const demoFacet = (0, facet_1.createFacet)({ initialValue: 'foo' });
    const renderedMock = jest.fn();
    const ComponentWithFacetEffect = () => {
        const adaptValue = (0, useFacetUnwrap_1.useFacetUnwrap)(demoFacet);
        renderedMock();
    ...
    const result = (0, dom_fiber_testing_library_1.render)(react_1.default.createElement(ComponentWithFacetEffect, null));
    expect(renderedMock).toHaveBeenCalledTimes(1);
    renderedMock.mockClear();
    (0, dom_fiber_testing_library_1.act)(() => {
        demoFacet.set('bar');
...
it('supports setting a facet multiple times in the same render with custom equality check', () => {
    ...
    const customEqualityCheck = () => (0, __1.defaultEqualityCheck)();
    const ComponentWithFacetEffect = () => {
        const adaptValue = (0, useFacetUnwrap_1.useFacetUnwrap)(demoFacet, customEqualityCheck);
        renderedMock();
        if (adaptValue === __1.NO_VALUE)
            return null;
        return react_1.default.createElement("span", null, adaptValue);
