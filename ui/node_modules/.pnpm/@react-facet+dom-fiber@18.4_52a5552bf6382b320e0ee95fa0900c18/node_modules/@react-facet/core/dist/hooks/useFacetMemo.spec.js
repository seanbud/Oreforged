...
describe('multiple dependencies', () => {
    ...
    it('only fires onces if both facets have initial values, and returned value is non-primitive', () => {
        const facetA = (0, facet_1.createFacet)({ initialValue: 4 });
        const facetB = (0, facet_1.createFacet)({ initialValue: 5 });
        const facetC = (0, facet_1.createFacet)({ initialValue: 6 });
        const mock = jest.fn();
        const ComponentWithFacetEffect = () => {
            const adaptValue = (0, useFacetMemo_1.useFacetMemo)((a, b, c) => ({ foo: a + b + c }), [], [facetA, facetB, facetC]);
            (0, useFacetEffect_1.useFacetEffect)((value) => {
                mock(value);
            }, [], [adaptValue]);
            return null;
