...
exports.setupAttributeUpdate = exports.setupViewBoxUpdate = exports.setupTextUpdate = exports.setupSrcUpdate = exports.setupValueUpdate = exports.setupRowsUpdate = exports.setupMaxLengthUpdate = exports.setupIdUpdate = exports.setupClassUpdate = exports.setupStyleUpdate = void 0;
const core_1 = require("@react-facet/core");
const setupStyleUpdate = (styleProp, style, styleUnsubscribers) => {
    for (const key in styleProp) {
        const value = styleProp[key];
        if (value !== undefined) {
            if ((0, core_1.isFacet)(value)) {
                styleUnsubscribers.set(key, value.observe((value) => {
                    style[key] = value;
                }));
            }
            else {
...
exports.setupStyleUpdate = setupStyleUpdate;
