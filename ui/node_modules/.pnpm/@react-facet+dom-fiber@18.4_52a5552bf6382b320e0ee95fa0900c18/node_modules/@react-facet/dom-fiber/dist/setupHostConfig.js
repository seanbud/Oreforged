...
exports.isTextElement = exports.setupHostConfig = void 0;
...
const setupHostConfig = () => ({
     ...
     */
    scheduleTimeout: typeof window !== 'undefined'
        ? window.setTimeout
     ...
     * Ex: screenshot testing
     */
    cancelTimeout: typeof window !== 'undefined' ? window.clearTimeout : (id) => window.clearTimeout(id),
    noTimeout: noop,
    ...
    createInstance: function (externalType, newProps) {
        ...
        if (newProps.style !== undefined) {
            ...
            (0, setupAttributes_1.setupStyleUpdate)(newProps.style, style, styleUnsubscribers);
        }
    ...
    hideInstance(instance) {
        var _a, _b;
        if ((0, exports.isTextElement)(instance.element)) {
    ...
    unhideInstance(instance, props) {
        var _a;
        if ((0, exports.isTextElement)(instance.element)) {
            instance.text = (0, setupAttributes_1.setupTextUpdate)(props.text, instance.element);
            return;
        }
        if (props.style !== undefined) {
            (0, setupAttributes_1.setupStyleUpdate)(props.style, ((_a = instance.style) !== null && _a !== void 0 ? _a : instance.element.style), instance.styleUnsubscribers);
        }
        else {
