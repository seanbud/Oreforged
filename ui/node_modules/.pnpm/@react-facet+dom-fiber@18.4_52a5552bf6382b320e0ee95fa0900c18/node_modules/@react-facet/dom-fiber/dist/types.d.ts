...
export type TypeHTML = 'fast-a' | 'fast-div' | 'fast-span' | 'fast-p' | 'fast-img' | 'fast-textarea' | 'fast-input' | 'fast-text' | 'a' | 'div' | 'p' | 'img' | 'textarea' | 'input' | 'style';
export type TypeSVG = 'fast-circle' | 'fast-ellipse' | 'fast-line' | 'fast-path' | 'fast-rect' | 'fast-svg' | 'fast-foreignObject' | 'fast-use' | 'fast-polyline' | 'fast-polygon' | 'fast-linearGradient' | 'fast-radialGradient' | 'fast-stop' | 'fast-svg-text' | 'fast-pattern' | 'circle' | 'ellipse' | 'line' | 'path' | 'rect' | 'svg' | 'defs' | 'g' | 'symbol' | 'use' | 'polyline' | 'polygon' | 'linearGradient' | 'radialGradient' | 'foreignObject' | 'stop' | 'text' | 'pattern';
 ...
 */
export type StrictReactNode = StrictReactElement | string | number | Iterable<ReactNode> | ReactPortal | boolean | null | undefined | FastTextElement;
export type ElementProps<T> = PointerEvents & FocusEvents & KeyboardEvents & {
    key?: string | number;
    /**
