...
it('supports unsubscribing as events are firing', () => {
    const updateOne = jest.fn();
    const mock = (0, createFacet_1.createFacet)({ startSubscription: () => () => { }, initialValue: types_1.NO_VALUE });
...
describe('cleanup', () => {
    it('keeps the value if no startSubscription is provided (useful for local facets)', () => {
        ...
        const mock = (0, createFacet_1.createFacet)({ initialValue: types_1.NO_VALUE });
    ...
    it('calls the cleanup function and resets the value when the last listener is removed', () => {
        ...
        const mock = (0, createFacet_1.createFacet)({ startSubscription, initialValue });
...
describe('setWithCallback', () => {
    it('prevents calling listeners if a setter returns NO_VALUE', () => {
        const facet = (0, createFacet_1.createFacet)({ initialValue: 10 });
        ...
        listenerMock.mockClear();
        facet.setWithCallback(() => types_1.NO_VALUE);
...
//# sourceMappingURL=createFacet.spec.js.map